...
public class LocalTechniqueService implements LocalTechniqueRepository {
    ...
    final String selectDispoRequestOrder = "SELECT_DISPO_LOCAUX_T";
    ...
    public Boolean insert(LocalTechnique LocalTechnique) throws InterruptedException, IOException {
    ...
    public LocalTechniques select() throws InterruptedException, IOException {
        int birthdate = 0;
        final Deque<ClientRequest> clientRequests = new ArrayDeque<ClientRequest>();
        final ObjectMapper objectMapper = new ObjectMapper();
        final String requestId = UUID.randomUUID().toString();
    ...
    public LocalTechniques selectDispo() throws InterruptedException, IOException {
        int birthdate = 0;
        final Deque<ClientRequest> clientRequests = new ArrayDeque<ClientRequest>();
        final ObjectMapper objectMapper = new ObjectMapper();
        final String requestId = UUID.randomUUID().toString();
    ...
    public Boolean update(LocalTechnique localTechnique) throws InterruptedException, IOException {
    ...
    public Boolean delete(LocalTechnique localTechnique) throws InterruptedException, IOException {
        try {
            final Deque<ClientRequest> clientRequests = new ArrayDeque<>();
            final ObjectMapper objectMapper = new ObjectMapper();
            final String requestId = UUID.randomUUID().toString();
