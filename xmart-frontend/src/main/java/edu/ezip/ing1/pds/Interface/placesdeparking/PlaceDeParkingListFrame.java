...
public class PlaceDeParkingListFrame extends JFrame {
    ...
    public PlaceDeParkingListFrame(PlaceDeParkingUseCase placeDeParkingUseCase) {
                ...
                if (e.isPopupTrigger() || SwingUtilities.isRightMouseButton(e)) {
                    ...
                    if (row >= 0 && row < table.getRowCount()) {
                        ...
                        reserverItem.addActionListener(ev -> {
                            JOptionPane.showMessageDialog(table, "Réservation en cours pour " + selected.getIdPlace());
                        });
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new PlaceDeParkingListFrame(placeDeParkingUseCase));
    }
}
